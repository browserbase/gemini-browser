 ...
 */
export declare function createModelContent(
 ...
 */
export declare function createPartFromBase64(
  data: string,
  mimeType: string,
): Part;
 ...
 */
export declare function createPartFromCodeExecutionResult(
  outcome: Outcome,
  output: string,
): Part;
 ...
 */
export declare function createPartFromExecutableCode(
  code: string,
  language: Language,
): Part;
 ...
 */
export declare function createPartFromFunctionCall(
  name: string,
 ...
 */
export declare function createPartFromFunctionResponse(
  id: string,
  name: string,
 ...
 */
export declare function createUserContent(
  partOrString: PartListUnion | string,
): Content;
...
export declare type DownloadableFileUnion =
  | string
  | File_2
  | GeneratedVideo
  | Video;
...
export declare class GenerateVideosOperation
...
export declare class LiveMusicSession {
  ...
  setMusicGenerationConfig(
    params: types.LiveMusicSetConfigParameters,
  ): Promise<void>;
 ...
 * versions.
 */
export declare function mcpToTool(
  ...args: [...Client[], CallableToolConfig | Client]
): CallableTool;
...
export declare class Operations extends BaseModule {
   ...
   * @return The updated Operation object, with the latest status or result.
   */
  get<T, U extends types.Operation<T>>(
...
export declare type ReferenceImage =
  | RawReferenceImage
  | MaskReferenceImage
 ...
 * ```
 */
export declare function setDefaultBaseUrls(
  baseUrlParams: BaseUrlParameters,
): void;
