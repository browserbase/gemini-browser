...
<Info>
  This server enables Claude to control browsers, navigate websites, interact
  with web elements, and extract data—all through simple conversational
  commands.
</Info>
...
<Info>
  The Browserbase MCP Server supports both single and multi-session
  architectures to accommodate different automation needs.
</Info>
...
<Step title="Configure Authentication">
  Set up your Browserbase API credentials in the MCP configuration. Get your API
  keys from the [Browserbase Dashboard](https://www.browserbase.com/overview).
</Step>
...
<Tip>
  Ready to get started? Check out our [Setup Guide](/integrations/mcp/setup) for
