...
(function (FeatureSelectionPreference) {
  ...
  exports.FeatureSelectionPreference ||
    (exports.FeatureSelectionPreference = {}),
);
...
(function (DynamicRetrievalConfigMode) {
  ...
  exports.DynamicRetrievalConfigMode ||
    (exports.DynamicRetrievalConfigMode = {}),
);
...
(function (FunctionResponseScheduling) {
  ...
  exports.FunctionResponseScheduling ||
    (exports.FunctionResponseScheduling = {}),
);
    ...
    if (isVertexAI) {
      ...
      if (response) {
        ...
        operationResponse.generatedVideos =
          responseVideos === null || responseVideos === void 0
            ? void 0
            : responseVideos.map((generatedVideo) => {
                return {
                  video: {
      ...
      if (response) {
        ...
        const responseVideos =
          generatedVideoResponse === null || generatedVideoResponse === void 0
            ? void 0
...
function flattenTypeArrayToAnyOf(typeList, resultingSchema) {
  ...
  if (listWithoutNull.length === 1) {
    resultingSchema["type"] = Object.values(exports.Type).includes(
...
function processJsonSchema(_jsonSchema) {
  ...
  for (const [fieldName, fieldValue] of Object.entries(_jsonSchema)) {
    ...
    if (fieldName == "type") {
      ...
      genAISchema["type"] = Object.values(exports.Type).includes(
...
class Batches extends BaseModule {
  constructor(apiClient) {
    ...
    this.list = async (params = {}) => {
      return new Pager(
        exports.PagedItem.PAGED_ITEM_BATCH_JOBS,
...
function toolToVertex$2(fromObject) {
  ...
  if (getValueByPath(fromObject, ["computerUse"]) !== undefined) {
...
class Caches extends BaseModule {
  constructor(apiClient) {
    ...
    this.list = async (params = {}) => {
      return new Pager(
        exports.PagedItem.PAGED_ITEM_CACHED_CONTENTS,
        (x) => this.listInternal(x),
        await this.listInternal(params),
        params,
      );
...
class Files extends BaseModule {
  constructor(apiClient) {
    ...
    this.list = async (params = {}) => {
      return new Pager(
        exports.PagedItem.PAGED_ITEM_FILES,
        (x) => this.listInternal(x),
        await this.listInternal(params),
        params,
      );
...
function proactivityConfigToMldev$1(fromObject) {
  const toObject = {};
  const fromProactiveAudio = getValueByPath(fromObject, ["proactiveAudio"]);
...
function liveMusicGenerationConfigToMldev(fromObject) {
  ...
  const fromOnlyBassAndDrums = getValueByPath(fromObject, ["onlyBassAndDrums"]);
...
function liveMusicClientMessageToMldev(fromObject) {
  ...
  const fromClientContent = getValueByPath(fromObject, ["clientContent"]);
  ...
  const fromPlaybackControl = getValueByPath(fromObject, ["playbackControl"]);
...
function audioChunkFromMldev(fromObject) {
  ...
  const fromSourceMetadata = getValueByPath(fromObject, ["sourceMetadata"]);
...
function liveMusicFilteredPromptFromMldev(fromObject) {
  ...
  const fromFilteredReason = getValueByPath(fromObject, ["filteredReason"]);
...
function liveMusicServerMessageFromMldev(fromObject) {
  ...
  const fromFilteredPrompt = getValueByPath(fromObject, ["filteredPrompt"]);
...
function styleReferenceConfigToVertex(fromObject) {
  const toObject = {};
  const fromStyleDescription = getValueByPath(fromObject, ["styleDescription"]);
...
class LiveMusicSession {
  ...
  async setWeightedPrompts(params) {
    ...
    const setWeightedPromptsParameters =
      liveMusicSetWeightedPromptsParametersToMldev(params);
    const clientContent = liveMusicClientContentToMldev(
  ...
  async connect(params) {
    ...
    const onopenAwaitedCallback = function () {
      ...
      (_a =
        callbacks === null || callbacks === void 0
          ? void 0
          : callbacks.onopen) === null || _a === void 0
        ? void 0
        : _a.call(callbacks);
      onopenResolve({});
    };
    ...
    if (
      ...
      ((_c = params.config) === null || _c === void 0
        ? void 0
        : _c.responseModalities) === undefined
    ) {
...
class Models extends BaseModule {
  constructor(apiClient) {
    ...
    this.list = async (params) => {
      ...
      return new Pager(
        exports.PagedItem.PAGED_ITEM_MODELS,
        (x) => this.listInternal(x),
        ...
        while (remoteCallCount < maxRemoteCalls) {
          ...
          try {
            for (
              ...
              if (
                chunk.candidates &&
                ((_a = chunk.candidates[0]) === null || _a === void 0
                  ? void 0
                  : _a.content)
              ) {
                responseContents.push(chunk.candidates[0].content);
                for (const part of (_b = chunk.candidates[0].content.parts) !==
                  null && _b !== void 0
                  ? _b
                  : []) {
                  if (remoteCallCount < maxRemoteCalls && part.functionCall) {
                    ...
                    if (!afcTools.has(part.functionCall.name)) {
                      throw new Error(
                        `Automatic function calling was requested, but not all the tools the model used implement the CallableTool interface. Available tools: ${afcTools.keys()}, mising tool: ${part.functionCall.name}`,
                      );
                    } else {
  ...
  async download(params, apiClient) {
    if (params.downloadPath) {
      ...
      if (response instanceof HttpResponse) {
        ...
        node_stream.Readable.fromWeb(response.responseInternal.body).pipe(
          writer,
        );
      } else {
        fs.writeFile(
...
async function downloadFile(params, apiClient) {
  ...
  if (name !== undefined) {
    ...
    const videoBytes =
      (_c = params.file.video) === null || _c === void 0
        ? void 0
        : _c.videoBytes;
...
class Tunings extends BaseModule {
  constructor(apiClient) {
    ...
    this.list = async (params = {}) => {
      return new Pager(
        exports.PagedItem.PAGED_ITEM_TUNING_JOBS,
        (x) => this.listInternal(x),
        await this.listInternal(params),
        params,
      );
    ...
    try {
      ...
      if (
        ((_c =
          response === null || response === void 0
            ? void 0
            : response.headers) === null || _c === void 0
          ? void 0
          : _c[X_GOOG_UPLOAD_STATUS_HEADER_FIELD]) !== "final"
      ) {
        throw new Error(
...
class GoogleGenAI {
  constructor(options) {
    ...
    this.vertexai =
      (_b =
        (_a = options.vertexai) !== null && _a !== void 0
          ? _a
          : getBooleanEnv("GOOGLE_GENAI_USE_VERTEXAI")) !== null &&
      _b !== void 0
        ? _b
        : false;
    ...
    this.apiKey =
      (_c = options.apiKey) !== null && _c !== void 0 ? _c : envApiKey;
    this.project =
      (_d = options.project) !== null && _d !== void 0 ? _d : envProject;
    this.location =
      (_e = options.location) !== null && _e !== void 0 ? _e : envLocation;
    // Handle when to use Vertex AI in express mode (api key)
    if (options.vertexai) {
      if (
        (_f = options.googleAuthOptions) === null || _f === void 0
          ? void 0
          : _f.credentials
      ) {
...
exports.GenerateContentResponsePromptFeedback =
  GenerateContentResponsePromptFeedback;
exports.GenerateContentResponseUsageMetadata =
