...
// Google types from the GoogleCUAClient
import type {
  Content as GoogleContent,
  Part as GooglePart,
} from "@google/genai";

// Type for function response data items
 ...
 */
export function findAnthropicItemsWithImages(
 ...
 */
export function compressAnthropicConversationImages(
  items: AnthropicResponseInputItem[],
