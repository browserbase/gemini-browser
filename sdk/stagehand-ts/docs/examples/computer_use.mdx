...
<iframe
  ...
  allowfullscreen
></iframe>
You might've heard of [Claude Computer
Use](https://www.anthropic.com/news/3-5-models-and-computer-use) or [OpenAI's
...
env: "BROWSERBASE",
apiKey: process.env.BROWSERBASE*API_KEY /* API key for authentication _/,
projectId: process.env.BROWSERBASE_PROJECT_ID /_ Project identifier \_/,
