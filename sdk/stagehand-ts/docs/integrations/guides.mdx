...
<Note>
  These examples are most relevant for TypeScript. The Python section is coming
  soon.
</Note>
...
>
  We've created a Github repository with plenty of ready-to-run guides for
  Stagehand, including persistent contexts and deploying to Vercel.
</Card>
